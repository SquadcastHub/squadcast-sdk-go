...
type AutoPauseTransientAlerts struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAutoPauseTransientAlerts(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AutoPauseTransientAlerts {
	return &AutoPauseTransientAlerts{
		rootSDK:          rootSDK,
...
func (s *AutoPauseTransientAlerts) MarkAsNotTransient(ctx context.Context, incidentID string, opts ...operations.Option) (*operations.AptaMarkAsNotTransientResponse, error) {
