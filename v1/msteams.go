...
func newMsteams(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Msteams {
	return &Msteams{
		rootSDK:          rootSDK,
...
func (s *Msteams) GetConfig(ctx context.Context, opts ...operations.Option) (*operations.MSTeamsGetMsteamsConfigResponse, error) {
