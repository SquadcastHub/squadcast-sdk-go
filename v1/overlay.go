...
func newOverlay(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Overlay {
	return &Overlay{
		rootSDK:          rootSDK,
...
func (s *Overlay) GetKeyBasedDeduplicationOptin(ctx context.Context, serviceID string, opts ...operations.Option) (*operations.OverlayGetOptinForKeyBasedDeduplicationForAServiceResponse, error) {
...
func (s *Overlay) OptInForKeyBasedDeduplication(ctx context.Context, serviceID string, v3ServicesOverlayOptInForKeyBasedDeduplicationRequest components.V3ServicesOverlayOptInForKeyBasedDeduplicationRequest, opts ...operations.Option) (*operations.OverlayOptinForKeyBasedDeduplicationForAServiceResponse, error) {
