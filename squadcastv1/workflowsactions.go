...
type WorkflowsActions struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newWorkflowsActions(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *WorkflowsActions {
...
func (s *WorkflowsActions) Create(ctx context.Context, workflowID string, v3WorkflowsActionRequest components.V3WorkflowsActionRequest, opts ...operations.Option) (*operations.WorkflowsCreateActionResponse, error) {
