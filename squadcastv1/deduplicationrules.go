...
func newDeduplicationRules(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *DeduplicationRules {
...
func (s *DeduplicationRules) Get(ctx context.Context, serviceID string, opts ...operations.Option) (*operations.DeduplicationRulesGetDeduplicationRulesResponse, error) {
...
func (s *DeduplicationRules) CreateOrUpdate(ctx context.Context, serviceID string, v3ServicesDeduplicationRulesCreateDeduplicationRulesRequest components.V3ServicesDeduplicationRulesCreateDeduplicationRulesRequest, opts ...operations.Option) (*operations.DeduplicationRulesCreateOrUpdateDeduplicationRulesResponse, error) {
