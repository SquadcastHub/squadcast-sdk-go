...
func newSuppressionRules(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SuppressionRules {
...
func (s *SuppressionRules) Get(ctx context.Context, serviceID string, opts ...operations.Option) (*operations.SuppressionRulesGetSuppressionRulesResponse, error) {
