...
func newAnalytics(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Analytics {
	return &Analytics{
		rootSDK:          rootSDK,
...
func (s *Analytics) GetOrganization(ctx context.Context, from string, to string, teamID *string, userID *string, opts ...operations.Option) (*operations.AnalyticsGetOrgAnalyticsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v3/analyticsv2/organization")
	if err != nil {
	...
	res := &operations.AnalyticsGetOrgAnalyticsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.AnalyticsGetOrgAnalyticsResponseBody
...
func (s *Analytics) GetTeam(ctx context.Context, request operations.AnalyticsGetTeamAnalyticsRequest, opts ...operations.Option) (*operations.AnalyticsGetTeamAnalyticsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v3/analyticsv2/team")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.AnalyticsGetTeamAnalyticsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.AnalyticsGetTeamAnalyticsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
