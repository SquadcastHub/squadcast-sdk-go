...
func newTaggingRules(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *TaggingRules {
	return &TaggingRules{
		rootSDK:          rootSDK,
...
// Get Tagging Rules
func (s *TaggingRules) Get(ctx context.Context, serviceID string, opts ...operations.Option) (*operations.TaggingRulesGetTaggingRulesResponse, error) {
