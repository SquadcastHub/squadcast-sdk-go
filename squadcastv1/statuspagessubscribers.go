...
type StatusPagesSubscribers struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newStatusPagesSubscribers(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *StatusPagesSubscribers {
	return &StatusPagesSubscribers{
		rootSDK:          rootSDK,
...
// StatusPagesListSubscribers - List Subscribers
func (s *StatusPagesSubscribers) StatusPagesListSubscribers(ctx context.Context, statuspageID string, opts ...operations.Option) (*operations.StatusPagesListSubscribersResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v4/statuspages/{statuspageID}/subscribers", request, nil)
	if err != nil {
	...
	res := &operations.StatusPagesListSubscribersResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V4StatusPagesListSubscribersResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V4StatusPagesListSubscribersResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
