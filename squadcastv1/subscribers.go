...
func newSubscribers(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Subscribers {
	return &Subscribers{
		rootSDK:          rootSDK,
...
// List Subscribers
func (s *Subscribers) List(ctx context.Context, statuspageID string, opts ...operations.Option) (*operations.StatusPagesListSubscribersResponse, error) {
