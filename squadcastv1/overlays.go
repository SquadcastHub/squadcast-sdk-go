...
func newOverlays(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Overlays {
	return &Overlays{
		rootSDK:          rootSDK,
...
func (s *Overlays) DeleteNotificationTemplate(ctx context.Context, serviceID string, alertSource string, opts ...operations.Option) (*operations.OverlayDeleteNotificationTemplateOverlayResponse, error) {
