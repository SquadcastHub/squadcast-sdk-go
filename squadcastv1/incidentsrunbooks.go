...
type IncidentsRunbooks struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newIncidentsRunbooks(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *IncidentsRunbooks {
	return &IncidentsRunbooks{
		rootSDK:          rootSDK,
...
func (s *IncidentsRunbooks) Attach(ctx context.Context, incidentID string, v3IncidentsRunbooksAttachRunbooksRequest components.V3IncidentsRunbooksAttachRunbooksRequest, opts ...operations.Option) (*operations.RunbooksAttachRunbooksResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/incidents/{IncidentId}/runbooks", request, nil)
	if err != nil {
	...
	res := &operations.RunbooksAttachRunbooksResponse{
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.RunbooksAttachRunbooksResponseBody
