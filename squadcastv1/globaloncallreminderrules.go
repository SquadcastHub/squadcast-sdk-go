...
func newGlobalOncallReminderRules(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *GlobalOncallReminderRules {
	return &GlobalOncallReminderRules{
		rootSDK:          rootSDK,
...
func (s *GlobalOncallReminderRules) Delete(ctx context.Context, ownerID string, opts ...operations.Option) (*operations.GlobalOncallReminderRulesDeleteGlobalOncallReminderRulesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v3/global-oncall-reminder-rules")
	if err != nil {
	...
	res := &operations.GlobalOncallReminderRulesDeleteGlobalOncallReminderRulesResponse{
...
func (s *GlobalOncallReminderRules) List(ctx context.Context, ownerID string, opts ...operations.Option) (*operations.GlobalOncallReminderRulesGetGlobalOncallReminderRulesResponse, error) {
	...
	res := &operations.GlobalOncallReminderRulesGetGlobalOncallReminderRulesResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GlobalOncallReminderRulesGetGlobalOncallReminderRulesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *GlobalOncallReminderRules) Create(ctx context.Context, request components.V3GlobalOncallReminderRulesCreateGlobalOncallReminderRulesRequest, opts ...operations.Option) (*operations.GlobalOncallReminderRulesCreateGlobalOncallReminderRulesResponse, error) {
	...
	res := &operations.GlobalOncallReminderRulesCreateGlobalOncallReminderRulesResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GlobalOncallReminderRulesCreateGlobalOncallReminderRulesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *GlobalOncallReminderRules) Update(ctx context.Context, ownerID string, v3GlobalOncallReminderRulesUpdateGlobalOncallReminderRulesRequest components.V3GlobalOncallReminderRulesUpdateGlobalOncallReminderRulesRequest, opts ...operations.Option) (*operations.GlobalOncallReminderRulesUpdateGlobalOncallReminderRulesResponse, error) {
	...
	res := &operations.GlobalOncallReminderRulesUpdateGlobalOncallReminderRulesResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GlobalOncallReminderRulesUpdateGlobalOncallReminderRulesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
