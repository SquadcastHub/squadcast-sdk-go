...
func newTokens(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Tokens {
	return &Tokens{
		rootSDK:          rootSDK,
...
func (s *Tokens) CreateUserToken(ctx context.Context, request operations.UsersCreateTokenRequest, opts ...operations.Option) (*operations.UsersCreateTokenResponse, error) {
