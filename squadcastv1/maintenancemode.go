...
func newMaintenanceMode(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MaintenanceMode {
...
func (s *MaintenanceMode) Get(ctx context.Context, serviceID string, opts ...operations.Option) (*operations.MaintenanceModeGetMaintenanceModeResponse, error) {
...
func (s *MaintenanceMode) CreateOrUpdate(ctx context.Context, serviceID string, v3ServicesMaintenanceModeCreateOrUpdateMaintenanceModeRequest components.V3ServicesMaintenanceModeCreateOrUpdateMaintenanceModeRequest, opts ...operations.Option) (*operations.MaintenanceModeCreateOrUpdateMaintenanceModeResponse, error) {
