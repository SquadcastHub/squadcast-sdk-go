...
type ServicesTaggingRules struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newServicesTaggingRules(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ServicesTaggingRules {
	return &ServicesTaggingRules{
		rootSDK:          rootSDK,
...
// TaggingRulesGetTaggingRules - Get Tagging Rules
func (s *ServicesTaggingRules) TaggingRulesGetTaggingRules(ctx context.Context, serviceID string, opts ...operations.Option) (*operations.TaggingRulesGetTaggingRulesResponse, error) {
	...
	res := &operations.TaggingRulesGetTaggingRulesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.TaggingRulesGetTaggingRulesResponseBody
...
// TaggingRulesCreateOrUpdateTaggingRules - Create or Update Tagging Rules
func (s *ServicesTaggingRules) TaggingRulesCreateOrUpdateTaggingRules(ctx context.Context, serviceID string, v3ServicesTaggingRulesCreateOrUpdateTaggingRulesRequest components.V3ServicesTaggingRulesCreateOrUpdateTaggingRulesRequest, opts ...operations.Option) (*operations.TaggingRulesCreateOrUpdateTaggingRulesResponse, error) {
