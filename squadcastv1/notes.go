...
func newNotes(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Notes {
	return &Notes{
		rootSDK:          rootSDK,
...
func (s *Notes) List(ctx context.Context, incidentID string, opts ...operations.Option) (*operations.NotesGetAllNotesResponse, error) {
