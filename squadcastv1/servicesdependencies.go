...
func newServicesDependencies(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ServicesDependencies {
...
// DependenciesCreateOrUpdateDependencies - Create or Update Dependencies
func (s *ServicesDependencies) DependenciesCreateOrUpdateDependencies(ctx context.Context, serviceID string, v3ServicesDependenciesCreateOrUpdateDependenciesRequest components.V3ServicesDependenciesCreateOrUpdateDependenciesRequest, opts ...operations.Option) (*operations.DependenciesCreateOrUpdateDependenciesResponse, error) {
