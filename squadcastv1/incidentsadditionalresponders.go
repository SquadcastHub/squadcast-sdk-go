...
type IncidentsAdditionalResponders struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newIncidentsAdditionalResponders(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *IncidentsAdditionalResponders {
	return &IncidentsAdditionalResponders{
		rootSDK:          rootSDK,
...
// AdditionalRespondersGetAdditionalResponders - Get Additional Responders
// - This endpoint is used to get the incident additional responders.
//
// - Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header.
func (s *IncidentsAdditionalResponders) AdditionalRespondersGetAdditionalResponders(ctx context.Context, incidentID string, opts ...operations.Option) (*operations.AdditionalRespondersGetAdditionalRespondersResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/incidents/{incidentID}/additional-responders", request, nil)
	if err != nil {
	...
	res := &operations.AdditionalRespondersGetAdditionalRespondersResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.AdditionalRespondersGetAdditionalRespondersResponseBody
...
// AdditionalRespondersAddAdditionalResponders - Add Additional Responders
// - This endpoint is used to add additional responders to an Incident.
//
// - Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header.
func (s *IncidentsAdditionalResponders) AdditionalRespondersAddAdditionalResponders(ctx context.Context, incidentID string, v3IncidentsAdditionalRespondersAddAdditionalRespondersRequest components.V3IncidentsAdditionalRespondersAddAdditionalRespondersRequest, opts ...operations.Option) (*operations.AdditionalRespondersAddAdditionalRespondersResponse, error) {
	request := operations.AdditionalRespondersAddAdditionalRespondersRequest{
		IncidentID: incidentID,
		V3IncidentsAdditionalRespondersAddAdditionalRespondersRequest: v3IncidentsAdditionalRespondersAddAdditionalRespondersRequest,
	}
	...
	res := &operations.AdditionalRespondersAddAdditionalRespondersResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.AdditionalRespondersAddAdditionalRespondersResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// AdditionalRespondersRemoveAdditionalResponders - Remove Additional Responders
// - This endpoint is used to remove an additional responder from an Incident.
//
// - Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header.
func (s *IncidentsAdditionalResponders) AdditionalRespondersRemoveAdditionalResponders(ctx context.Context, incidentID string, responderID string, opts ...operations.Option) (*operations.AdditionalRespondersRemoveAdditionalRespondersResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/incidents/{incidentID}/additional-responders/{responderID}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.AdditionalRespondersRemoveAdditionalRespondersResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
