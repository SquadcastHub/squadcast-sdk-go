...
func newMembers(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Members {
	return &Members{
		rootSDK:          rootSDK,
...
func (s *Members) GetAll(ctx context.Context, teamID string, opts ...operations.Option) (*operations.TeamsGetAllTeamMembersResponse, error) {
