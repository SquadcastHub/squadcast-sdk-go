...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.716.14
...
func New(opts ...SDKOption) *SquadcastSDK {
	sdk := &SquadcastSDK{
		SDKVersion: "1.1.7",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.1.7 2.716.14 1.0.0 github.com/SquadcastHub/squadcast-sdk-go/squadcastv1",
