...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.715.0
...
func New(opts ...SDKOption) *SquadcastSDK {
	sdk := &SquadcastSDK{
		SDKVersion: "1.1.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.1.1 2.715.0 1.0.0 github.com/SquadcastHub/squadcast-sdk-go/squadcastv1",
