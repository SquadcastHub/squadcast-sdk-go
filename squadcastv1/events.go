...
func newEvents(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Events {
	return &Events{
		rootSDK:          rootSDK,
...
// ```
func (s *Events) List(ctx context.Context, request operations.IncidentsGetIncidentEventsRequest, opts ...operations.Option) (*operations.IncidentsGetIncidentEventsResponse, error) {
