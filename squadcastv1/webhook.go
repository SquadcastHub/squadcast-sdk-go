...
func newWebhook(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Webhook {
	return &Webhook{
		rootSDK:          rootSDK,
...
func (s *Webhook) TriggerManually(ctx context.Context, incidentID string, eventWebhookID string, opts ...operations.Option) (*operations.IncidentActionsTriggerAWebhookManuallyResponse, error) {
