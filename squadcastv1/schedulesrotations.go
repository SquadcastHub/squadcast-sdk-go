...
type SchedulesRotations struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newSchedulesRotations(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SchedulesRotations {
	return &SchedulesRotations{
		rootSDK:          rootSDK,
...
func (s *SchedulesRotations) List(ctx context.Context, scheduleID string, opts ...operations.Option) (*operations.RotationsGetScheduleRotationsResponse, error) {
