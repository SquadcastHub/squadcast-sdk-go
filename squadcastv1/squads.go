...
func (s *Squads) Create(ctx context.Context, request components.V3SquadsCreateSquadRequest, opts ...operations.Option) (*operations.SquadsCreateSquadResponse, error) {
...
func (s *Squads) GetByID(ctx context.Context, squadID string, opts ...operations.Option) (*operations.SquadsGetSquadByIDResponse, error) {
...
// Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header with `squad-update` scope.
func (s *Squads) Update(ctx context.Context, squadID string, v3SquadsUpdateSquadRequest components.V3SquadsUpdateSquadRequest, opts ...operations.Option) (*operations.SquadsUpdateSquadResponse, error) {
...
// Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header with `squad-read` scope.
func (s *Squads) List(ctx context.Context, opts ...operations.Option) (*operations.SquadsGetAllSquadsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
