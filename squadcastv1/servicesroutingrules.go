...
type ServicesRoutingRules struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newServicesRoutingRules(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ServicesRoutingRules {
	return &ServicesRoutingRules{
		rootSDK:          rootSDK,
...
// RoutingRulesGetRoutingRules - Get Routing Rules
func (s *ServicesRoutingRules) RoutingRulesGetRoutingRules(ctx context.Context, serviceID string, opts ...operations.Option) (*operations.RoutingRulesGetRoutingRulesResponse, error) {
...
// RoutingRulesCreateOrUpdateRoutingRules - Create or Update Routing Rules
func (s *ServicesRoutingRules) RoutingRulesCreateOrUpdateRoutingRules(ctx context.Context, serviceID string, v3ServicesRoutingRulesCreateOrUpdateRoutingRulesRequest components.V3ServicesRoutingRulesCreateOrUpdateRoutingRulesRequest, opts ...operations.Option) (*operations.RoutingRulesCreateOrUpdateRoutingRulesResponse, error) {
	request := operations.RoutingRulesCreateOrUpdateRoutingRulesRequest{
		ServiceID: serviceID,
		V3ServicesRoutingRulesCreateOrUpdateRoutingRulesRequest: v3ServicesRoutingRulesCreateOrUpdateRoutingRulesRequest,
	}
	...
	res := &operations.RoutingRulesCreateOrUpdateRoutingRulesResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.RoutingRulesCreateOrUpdateRoutingRulesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
