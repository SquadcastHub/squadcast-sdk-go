...
type ExtensionsMSTeams struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newExtensionsMSTeams(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ExtensionsMSTeams {
	return &ExtensionsMSTeams{
		rootSDK:          rootSDK,
...
// MSTeamsGetMsteamsConfig - Get MSTeams Config
// Returns MSTeams config of the organization.
// Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header with `read` scope.
func (s *ExtensionsMSTeams) MSTeamsGetMsteamsConfig(ctx context.Context, opts ...operations.Option) (*operations.MSTeamsGetMsteamsConfigResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v3/extensions/msteams/config")
	if err != nil {
	...
	res := &operations.MSTeamsGetMsteamsConfigResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.MSTeamsGetMsteamsConfigResponseBody
...
// MSTeamsCreateOrUpdateMsteamsConfiguration - Create Or Update MSTeams Configuration
// Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header with `user-write` scope.
func (s *ExtensionsMSTeams) MSTeamsCreateOrUpdateMsteamsConfiguration(ctx context.Context, request components.V3ExtensionsMSTeamsCreateOrUpdateMSTeamsConfigRequest, opts ...operations.Option) (*operations.MSTeamsCreateOrUpdateMsteamsConfigurationResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.MSTeamsCreateOrUpdateMsteamsConfigurationResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.MSTeamsCreateOrUpdateMsteamsConfigurationResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
