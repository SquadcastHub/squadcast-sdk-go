...
func (s *ExtensionsMsteams) UpsertConfig(ctx context.Context, request components.V3ExtensionsMSTeamsCreateOrUpdateMSTeamsConfigRequest, opts ...operations.Option) (*operations.MSTeamsCreateOrUpdateMsteamsConfigurationResponse, error) {
