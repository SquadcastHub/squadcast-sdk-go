...
type SnoozeNotifications struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newSnoozeNotifications(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SnoozeNotifications {
...
func (s *SnoozeNotifications) Snooze(ctx context.Context, incidentID string, v3IncidentsSnoozeNotificationsSnoozeIncidentRequest components.V3IncidentsSnoozeNotificationsSnoozeIncidentRequest, opts ...operations.Option) (*operations.SnoozeNotificationsSnoozeIncidentNotificationsResponse, error) {
