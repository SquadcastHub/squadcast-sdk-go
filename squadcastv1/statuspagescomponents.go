...
type StatusPagesComponents struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newStatusPagesComponents(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *StatusPagesComponents {
	return &StatusPagesComponents{
		rootSDK:          rootSDK,
...
func (s *StatusPagesComponents) ComponentsListComponents(ctx context.Context, statuspageID string, opts ...operations.Option) (*operations.ComponentsListComponentsResponse, error) {
...
// ComponentsCreateComponent - Create Component
func (s *StatusPagesComponents) ComponentsCreateComponent(ctx context.Context, statuspageID string, v4StatusPagesComponentsCreateComponentRequest components.V4StatusPagesComponentsCreateComponentRequest, opts ...operations.Option) (*operations.ComponentsCreateComponentResponse, error) {
...
// ComponentsDeleteComponentByID - Delete Component By ID
func (s *StatusPagesComponents) ComponentsDeleteComponentByID(ctx context.Context, statuspageID string, componentID string, opts ...operations.Option) (*operations.ComponentsDeleteComponentByIDResponse, error) {
...
// ComponentsGetComponentByID - Get Component By ID
func (s *StatusPagesComponents) ComponentsGetComponentByID(ctx context.Context, statuspageID string, componentID string, opts ...operations.Option) (*operations.ComponentsGetComponentByIDResponse, error) {
...
// ComponentsUpdateComponentByID - Update Component By ID
func (s *StatusPagesComponents) ComponentsUpdateComponentByID(ctx context.Context, statuspageID string, componentID string, v4StatusPagesComponentsUpdateComponentByIDRequest components.V4StatusPagesComponentsUpdateComponentByIDRequest, opts ...operations.Option) (*operations.ComponentsUpdateComponentByIDResponse, error) {
