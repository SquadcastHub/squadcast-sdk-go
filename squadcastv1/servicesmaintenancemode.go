...
type ServicesMaintenanceMode struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newServicesMaintenanceMode(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ServicesMaintenanceMode {
	return &ServicesMaintenanceMode{
		rootSDK:          rootSDK,
...
// MaintenanceModeGetMaintenanceMode - Get Maintenance Mode
func (s *ServicesMaintenanceMode) MaintenanceModeGetMaintenanceMode(ctx context.Context, serviceID string, opts ...operations.Option) (*operations.MaintenanceModeGetMaintenanceModeResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/services/{serviceID}/maintenance", request, nil)
	if err != nil {
	...
	res := &operations.MaintenanceModeGetMaintenanceModeResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.MaintenanceModeGetMaintenanceModeResponseBody
...
// MaintenanceModeCreateOrUpdateMaintenanceMode - Create or Update Maintenance Mode
func (s *ServicesMaintenanceMode) MaintenanceModeCreateOrUpdateMaintenanceMode(ctx context.Context, serviceID string, v3ServicesMaintenanceModeCreateOrUpdateMaintenanceModeRequest components.V3ServicesMaintenanceModeCreateOrUpdateMaintenanceModeRequest, opts ...operations.Option) (*operations.MaintenanceModeCreateOrUpdateMaintenanceModeResponse, error) {
	request := operations.MaintenanceModeCreateOrUpdateMaintenanceModeRequest{
		ServiceID: serviceID,
		V3ServicesMaintenanceModeCreateOrUpdateMaintenanceModeRequest: v3ServicesMaintenanceModeCreateOrUpdateMaintenanceModeRequest,
	}
	...
	res := &operations.MaintenanceModeCreateOrUpdateMaintenanceModeResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.MaintenanceModeCreateOrUpdateMaintenanceModeResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
