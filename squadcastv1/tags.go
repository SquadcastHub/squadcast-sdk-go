...
func newTags(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Tags {
	return &Tags{
		rootSDK:          rootSDK,
...
// Update Tag
func (s *Tags) Update(ctx context.Context, incidentID string, v3IncidentsTagsUpdateTagRequest components.V3IncidentsTagsUpdateTagRequest, opts ...operations.Option) (*operations.TagsUpdateTagResponse, error) {
...
// Append Tag
func (s *Tags) Append(ctx context.Context, incidentID string, v3IncidentsTagsAppendTagRequest components.V3IncidentsTagsAppendTagRequest, opts ...operations.Option) (*operations.TagsAppendTagResponse, error) {
