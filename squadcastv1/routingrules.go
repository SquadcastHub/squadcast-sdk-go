...
func newRoutingRules(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *RoutingRules {
	return &RoutingRules{
		rootSDK:          rootSDK,
...
func (s *RoutingRules) CreateOrUpdate(ctx context.Context, serviceID string, v3ServicesRoutingRulesCreateOrUpdateRoutingRulesRequest components.V3ServicesRoutingRulesCreateOrUpdateRoutingRulesRequest, opts ...operations.Option) (*operations.RoutingRulesCreateOrUpdateRoutingRulesResponse, error) {
