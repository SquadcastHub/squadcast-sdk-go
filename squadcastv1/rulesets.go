...
func newRulesets(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Rulesets {
	return &Rulesets{
		rootSDK:          rootSDK,
		sdkConfiguration: sdkConfig,
		hooks:            hooks,
		Rules:            newRulesetsRules(rootSDK, sdkConfig, hooks),
	}
}

// Create Ruleset
// Create a GER Ruleset.
func (s *Rulesets) Create(ctx context.Context, gerID int64, v3GlobalEventRulesCreateRulesetRequest components.V3GlobalEventRulesCreateRulesetRequest, opts ...operations.Option) (*operations.GlobalEventRulesCreateRulesetResponse, error) {
...
func (s *Rulesets) Reorder(ctx context.Context, gerID int64, alertSourceVersion string, alertSourceShortname string, v3GlobalEventRulesReorderRulesetRequest components.V3GlobalEventRulesReorderRulesetRequest, opts ...operations.Option) (*operations.GlobalEventRulesReorderRulesetResponse, error) {
...
func (s *Rulesets) ListRulesetRules(ctx context.Context, request operations.GlobalEventRulesListRulesetRulesRequest, opts ...operations.Option) (*operations.GlobalEventRulesListRulesetRulesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
