...
func newDedupKey(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *DedupKey {
	return &DedupKey{
		rootSDK:          rootSDK,
...
func (s *DedupKey) Render(ctx context.Context, serviceID string, v3ServicesOverlayRenderDedupKeyTemplateRequest components.V3ServicesOverlayRenderDedupKeyTemplateRequest, opts ...operations.Option) (*operations.OverlayRenderDedupKeyTemplateResponse, error) {
...
func (s *DedupKey) Delete(ctx context.Context, serviceID string, alertSource string, opts ...operations.Option) (*operations.OverlayDeleteDedupKeyOverlayResponse, error) {
