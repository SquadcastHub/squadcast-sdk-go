...
type ServicesOverlay struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newServicesOverlay(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ServicesOverlay {
...
// OverlayGetOptinForKeyBasedDeduplicationForAService - Get Opt-in for Key Based Deduplication for a service
func (s *ServicesOverlay) OverlayGetOptinForKeyBasedDeduplicationForAService(ctx context.Context, serviceID string, opts ...operations.Option) (*operations.OverlayGetOptinForKeyBasedDeduplicationForAServiceResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/services/{serviceID}/config", request, nil)
	if err != nil {
	...
	res := &operations.OverlayGetOptinForKeyBasedDeduplicationForAServiceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.OverlayGetOptinForKeyBasedDeduplicationForAServiceResponseBody
...
// OverlayOptinForKeyBasedDeduplicationForAService - Opt-in for Key Based Deduplication for a service
func (s *ServicesOverlay) OverlayOptinForKeyBasedDeduplicationForAService(ctx context.Context, serviceID string, v3ServicesOverlayOptInForKeyBasedDeduplicationRequest components.V3ServicesOverlayOptInForKeyBasedDeduplicationRequest, opts ...operations.Option) (*operations.OverlayOptinForKeyBasedDeduplicationForAServiceResponse, error) {
	request := operations.OverlayOptinForKeyBasedDeduplicationForAServiceRequest{
		ServiceID: serviceID,
		V3ServicesOverlayOptInForKeyBasedDeduplicationRequest: v3ServicesOverlayOptInForKeyBasedDeduplicationRequest,
	}
	...
	res := &operations.OverlayOptinForKeyBasedDeduplicationForAServiceResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.OverlayOptinForKeyBasedDeduplicationForAServiceResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
