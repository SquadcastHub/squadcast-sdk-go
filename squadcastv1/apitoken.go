...
func newAPIToken(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *APIToken {
	return &APIToken{
		rootSDK:          rootSDK,
...
func (s *APIToken) Remove(ctx context.Context, refreshTokenID string, opts ...operations.Option) (*operations.UsersRemoveTokenResponse, error) {
