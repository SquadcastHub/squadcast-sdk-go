...
func newRules(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Rules {
	return &Rules{
		rootSDK:          rootSDK,
...
func (s *Rules) ReorderByIndex(ctx context.Context, request operations.GlobalEventRulesReorderRulesetByIndexRequest, opts ...operations.Option) (*operations.GlobalEventRulesReorderRulesetByIndexResponse, error) {
