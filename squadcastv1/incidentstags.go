...
type IncidentsTags struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newIncidentsTags(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *IncidentsTags {
	return &IncidentsTags{
		rootSDK:          rootSDK,
...
func (s *IncidentsTags) TagsUpdateTag(ctx context.Context, incidentID string, v3IncidentsTagsUpdateTagRequest components.V3IncidentsTagsUpdateTagRequest, opts ...operations.Option) (*operations.TagsUpdateTagResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/incidents/{IncidentId}/tags", request, nil)
	if err != nil {
	...
	res := &operations.TagsUpdateTagResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.TagsUpdateTagResponseBody
...
// TagsAppendTag - Append Tag
func (s *IncidentsTags) TagsAppendTag(ctx context.Context, incidentID string, v3IncidentsTagsAppendTagRequest components.V3IncidentsTagsAppendTagRequest, opts ...operations.Option) (*operations.TagsAppendTagResponse, error) {
	...
	res := &operations.TagsAppendTagResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.TagsAppendTagResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
