...
type ServicesSuppressionRules struct {
	rootSDK          *SquadcastSDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newServicesSuppressionRules(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ServicesSuppressionRules {
	return &ServicesSuppressionRules{
		rootSDK:          rootSDK,
...
// SuppressionRulesGetSuppressionRules - Get Suppression Rules
func (s *ServicesSuppressionRules) SuppressionRulesGetSuppressionRules(ctx context.Context, serviceID string, opts ...operations.Option) (*operations.SuppressionRulesGetSuppressionRulesResponse, error) {
	...
	res := &operations.SuppressionRulesGetSuppressionRulesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.SuppressionRulesGetSuppressionRulesResponseBody
...
// SuppressionRulesCreateOrUpdateSuppressionRules - Create or Update Suppression Rules
func (s *ServicesSuppressionRules) SuppressionRulesCreateOrUpdateSuppressionRules(ctx context.Context, serviceID string, v3ServicesSuppressionRulesCreateOrUpdateSuppressionRulesRequest components.V3ServicesSuppressionRulesCreateOrUpdateSuppressionRulesRequest, opts ...operations.Option) (*operations.SuppressionRulesCreateOrUpdateSuppressionRulesResponse, error) {
