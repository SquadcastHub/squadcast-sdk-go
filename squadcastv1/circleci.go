...
func newCircleci(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Circleci {
	return &Circleci{
		rootSDK:          rootSDK,
...
func (s *Circleci) Rebuild(ctx context.Context, incidentID string, buildNumber string, v3IncidentsIncidentActionsRebuildCircleCIProjectRequest components.V3IncidentsIncidentActionsRebuildCircleCIProjectRequest, opts ...operations.Option) (*operations.IncidentActionsRebuildAProjectInCircleciResponse, error) {
