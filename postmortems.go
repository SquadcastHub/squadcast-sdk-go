...
func newPostmortems(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Postmortems {
	return &Postmortems{
		rootSDK:          rootSDK,
...
func (s *Postmortems) DeleteByIncident(ctx context.Context, incidentID string, opts ...operations.Option) (*operations.PostmortemsDeletePostmortemByIncidentResponse, error) {
...
// *   Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header.
func (s *Postmortems) GetByIncident(ctx context.Context, incidentID string, opts ...operations.Option) (*operations.PostmortemsGetPostmortemByIncidentResponse, error) {
...
// *   Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header.
func (s *Postmortems) Create(ctx context.Context, incidentID string, v3IncidentsPostmortemsCreatePostmortemRequest components.V3IncidentsPostmortemsCreatePostmortemRequest, opts ...operations.Option) (*operations.PostmortemsCreatePostmortemResponse, error) {
