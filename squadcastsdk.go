...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.778.0
...
func New(opts ...SDKOption) *SquadcastSDK {
	sdk := &SquadcastSDK{
		SDKVersion: "1.4.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.4.0 2.778.0 1.0.0 github.com/SquadcastHub/squadcast-sdk-go",
